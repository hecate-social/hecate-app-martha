%%% @doc Process manager: on division_identified_v1, initiate division planning.
%%%
...
%%% @end
-module(on_division_identified_initiate_division_planning).
-behaviour(gen_server).
-export([start_link/0]).
-export([init/1, handle_call/3, handle_cast/2, handle_info/2, terminate/2]).

-define(EVENT_TYPE, <<"division_identified_v1">>).
-define(SUB_NAME, <<"on_division_identified_initiate_division_planning">>).
