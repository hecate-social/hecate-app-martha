%%% @doc Projection subscriber: desk_planned_v1 -> sqlite planned_desks
...
-define(SUB_NAME, <<"desk_planned_v1_to_planned_desks">>).
...
handle_info({events, Events}, State) ->
    lists:foreach(fun(E) ->
        case desk_planned_v1_to_sqlite_planned_desks:project(app_marthad_projection_event:to_map(E)) of
            ok -> ok;
            {error, Reason} ->
