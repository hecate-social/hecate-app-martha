%%% @doc LLM runner PM: on reviewer initiated, run LLM and complete/fail.
%%% Subscribes to reviewer_initiated_v1 from orchestration_store.
...
-define(SUB_NAME, <<"on_reviewer_initiated_run_reviewer_llm">>).
