%%% @doc LLM runner event handler: on coordinator initiated, run LLM and complete/fail.
%%% Reacts to coordinator_initiated_v1 events.
...
interested_in() -> [<<"coordinator_initiated_v1">>].
