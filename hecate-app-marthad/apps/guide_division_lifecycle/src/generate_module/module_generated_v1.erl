...
to_map(#module_generated_v1{} = E) ->
    #{
        ...
        path => E#module_generated_v1.path,
        generated_at => E#module_generated_v1.generated_at
    }.
    ...
    case {DivisionId, ModuleName} of
        ...
        _ ->
            {ok, #module_generated_v1{
                division_id = DivisionId,
                module_name = ModuleName,
                module_type = get_value(module_type, Map, <<>>),
...
-spec get_module_type(module_generated_v1()) -> binary().
get_module_type(#module_generated_v1{module_type = V}) -> V.

-spec get_path(module_generated_v1()) -> binary().
