...
do_generate(DivisionId, Params, Req) ->
    ModuleName = app_marthad_api_utils:get_field(module_name, Params),
    ModuleType = app_marthad_api_utils:get_field(module_type, Params),
    Path = app_marthad_api_utils:get_field(path, Params),
    CmdParams = #{
