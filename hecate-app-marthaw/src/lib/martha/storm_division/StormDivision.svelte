<script lang="ts">
	...
	import {
		...
		designEvent,
		planDesk
	} from '$lib/martha/storm_division/storm_division.js';
	import type { DeskCard, ExecutionMode } from '$lib/martha/storm_division/storm_division.js';
	import { openAIAssist } from '$lib/martha/shared/aiStore.js';
	import { designLevelAgents, type AgentPrompt } from '$lib/martha/shared/agentsStore.js';
