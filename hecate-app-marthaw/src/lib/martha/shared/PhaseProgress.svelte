<script lang="ts">
	...
	import { selectedPhase, openPhase, shelvePhase, resumePhase, concludePhase, isLoading } from '$lib/martha/shared/phaseStore.js';
	import { PHASES, openAIAssist } from '$lib/martha/shared/aiStore.js';
	import {
		phaseStatusLabel,
		phaseAvailableActions,
		type PhaseCode
	} from '$lib/martha/types.js';
