<script lang="ts">
	import {
		...
		setAIModelOverride,
		phaseAffinity
	} from '$lib/martha/shared/aiStore.js';
	...
	import { postEventSticky } from '$lib/martha/storm_venture_big_picture/storm_venture_big_picture.js';
	import { systemPrompt } from '$lib/martha/shared/personality.js';
	import { assistGeneralPrompt } from '$lib/martha/shared/agentsStore.js';
	import { createStudioContext, type ChatStream } from '$lib/martha/shared/context.js';
	import { autoSpeak, isSpeaking } from '$lib/martha/shared/aiStore.js';
					...
					>
						...
						{#if !msg.content.startsWith('Error:')}
							<button
								...
								disabled={$isSpeaking}
								class="mt-1 text-surface-500 hover:text-hecate-400 transition-colors opacity-0 group-hover:opacity-100
