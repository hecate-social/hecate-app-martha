<script lang="ts">
	...
	import { refineVision, submitVision } from '$lib/martha/compose_vision/compose_vision.js';
	import { hasFlag, VL_DISCOVERING, VL_DISCOVERY_PAUSED, VL_ARCHIVED } from '$lib/martha/types.js';
