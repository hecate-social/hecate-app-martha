...
export async function designAggregate(
	...
	try {
		...
		stormError.set(err.message || 'Failed to design aggregate');
		return false;
	}
}
...
export async function designEvent(
	...
	try {
		...
		const err = e as { message?: string };
		stormError.set(err.message || 'Failed to design event');
		return false;
	}
}
...
export async function planDesk(
	...
	try {
		...
		const err = e as { message?: string };
		stormError.set(err.message || 'Failed to plan desk');
		return false;
	}
}
...
export async function planDependency(
	...
	try {
		...
		const err = e as { message?: string };
		stormError.set(err.message || 'Failed to plan dependency');
		return false;
	}
}
